...
RTC_DATA_ATTR char sensorDataBuffer[3600];
...
void setup() {
  ...
  Serial.println("Data: " + String(sensorDataBuffer)); 
...
void print_wakeup_reason(){
  ...
  switch(wakeup_reason){
    case ESP_SLEEP_WAKEUP_EXT1 : Serial.println("Wakeup caused by external signal using RTC_IO"); LORA = true; SDCARD = false; break;
    case ESP_SLEEP_WAKEUP_TIMER : Serial.println("Wakeup caused by timer"); SDCARD = true; LORA = false; break;
